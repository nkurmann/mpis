...
;(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		bindNavTimer : function() {
			var tempThis = this;
			myVartimer = setTimeout(function() {
				// alert(tempThis._currentPageNum );
				if (tempThis._numPages != 1) {
					if (tempThis._numPages != tempThis._currentPageNum) {
						newPage = tempThis._currentPageNum + 1;
					} else {
						newPage = 1;
					}

					tempThis.paginate(newPage);

					tempThis.bindNavTimer();
